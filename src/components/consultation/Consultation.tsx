...
import { HeightUnits, IInitialConsultationValues, TemperatureUnits, WeightUnits, ConsumptionRangeTypes, AppointmentMedicineUnits, AdministrationRoutes } from "interfaces/appointment";
...
export const Consultation = () => {
    ...
    const handleSendData = (values: IInitialConsultationValues, helpers: FormikHelpers<any>) => {
